export const altars = [
  ...
  { x: -44.0233, y: 132.5975, name: "Fiabre", description: "Willpower +2" },
  {
    x: -50.490555,
    y: 117.590576,
    name: "Torvstrath",
  ...
  { x: -55.91973, y: 129.6229, name: "Loch Raeth", description: "Strength +2" },
  {
    x: -53.68808,
    y: 144.86867,
    name: "The Blood Vale",
  ...
  { x: -119.935, y: 66.519936, name: "Alcarnus", description: "Dexterity +2" },
  {
    x: -110.33348,
    y: 46.300095,
    name: "Altar of Ruin",
